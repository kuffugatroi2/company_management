        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content d-none" id="filter-form">
                    <br />
                    <form action="{{ route('projects.index') }}" method="GET" id="demo-form2" data-parsley-validate
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-9 col-sm-9 ">
                                            <input type="text" class="form-control" name="name"
                                                placeholder="Vui lòng nhập dự án cần tìm">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm d-flex justify-content-end">
                                            <a href="{{ route('projects.create') }}" class="btn btn-success">Tạo mới</a>
                                            <button class="btn btn-danger delete-all"
                                                onclick="return confirm('Bạn có chắc muốn xóa những dự án này không?')">Xóa
                                                all</button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            @foreach ($data['projects'] as $value)
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-center">
                                                        <form action="{{ route('projects.destroy', encrypt($value->id)) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu text-center"
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('projects.edit', encrypt($value->id)) }}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteAll.addEventListener('click', function() {
                ...
                if (selectedIds.length > 0) {
                    fetch('{{ route('projects.delete_all') }}', {
                            method: 'POST',
                            headers: {
